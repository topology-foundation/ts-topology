...
describe("G-Counter Tests", () => {
	...
	test("Test Compare", () => {
		const set2 = new GCounter({ node1: 5, node2: 10 });
		const set3 = new GCounter({ node1: 5, node2: 10, node3: 15 });
	...
	test("Test Merge", () => {
		const set2 = new GCounter({ node1: 3, node2: 10 });
		const set3 = new GCounter({ node1: 5, node3: 15 });
