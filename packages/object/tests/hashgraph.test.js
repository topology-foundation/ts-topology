...
import { OperationType, TopologyObject } from "../src/index.js";
describe("HashGraph for AddWinSet tests", () => {
    let obj1;
    let obj2;
    let obj3;
    beforeEach(async () => {
        obj1 = new TopologyObject("peer1", new AddWinsSet());
        obj2 = new TopologyObject("peer2", new AddWinsSet());
        obj3 = new TopologyObject("peer3", new AddWinsSet());
    });
...
describe("HashGraph for PseudoRandomWinsSet tests", () => {
    ...
    let obj5;
    beforeEach(async () => {
        obj1 = new TopologyObject("peer1", new PseudoRandomWinsSet());
...
describe("HashGraph for undefined operations tests", () => {
    ...
    test("Test: addToFrontier with undefined operation return Vertex with NoOp operation", () => {
        ...
        const createdVertex = obj1.hashGraph.addToFrontier(undefined);
