...
export const Update = {
  encode(_: Update, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): Update {
    return {};
  },

  toJSON(_: Update): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Update>, I>>(_: I): Update {
    const message = createBaseUpdate();
    return message;
  },
};
