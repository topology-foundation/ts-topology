	...
	fromJSON(object: any): Vertex {
		return {
			...
			operation: isSet(object.operation)
				? Vertex_Operation.fromJSON(object.operation)
				: undefined,
...
export const Vertex_Operation = {
	...
	create<I extends Exact<DeepPartial<Vertex_Operation>, I>>(
		base?: I,
	): Vertex_Operation {
		return Vertex_Operation.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<Vertex_Operation>, I>>(
		object: I,
	): Vertex_Operation {
		const message = createBaseVertex_Operation();
...
export const SyncAccept = {
	...
	fromJSON(object: any): SyncAccept {
		return {
			objectId: isSet(object.objectId)
				? globalThis.String(object.objectId)
				: "",
			diff: globalThis.Array.isArray(object?.diff)
				? object.diff.map((e: any) => Vertex.fromJSON(e))
				: [],
			missing: globalThis.Array.isArray(object?.missing)
				? object.missing.map((e: any) => globalThis.String(e))
				: [],
		};
	},
	...
	fromPartial<I extends Exact<DeepPartial<SyncAccept>, I>>(
		object: I,
	): SyncAccept {
		const message = createBaseSyncAccept();
		message.objectId = object.objectId ?? "";
